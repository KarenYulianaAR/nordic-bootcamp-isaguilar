 ...
 */
function View(props) {
  const { i18n, translations, site, siteId, lowEnd, deviceType, company, imagesPrefix, username } = props;
  ...
  const getUserWelcomeLegend = () => {
    const user = username || 'you';
    return (`${i18n.gettext('Welcome')} ${user}!`);
  };
